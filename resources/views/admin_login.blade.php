...
<body>
	...
	<!-- start: JavaScript-->
        ...
        <script type="text/javascript" src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bbotbox.min.js')}}"></script>

        <script>
            $(document).on("click", "#delete", function(e){
                e.preventDefault();
                var link = $(this).attr("href");
                bootbox.comfirm("Are you want you delete!!!", function(confirmed){
                    if(confirmed){
